...
import {PersonAdd, PlusOneOutlined, TaskAlt} from "@mui/icons-material";
...
function formatDatetime(dateTime: DateTime | null): string {
    if (dateTime == null) {
        return ""
    }
...
function EnhancedTable(props: TableProps) {
    ...
    function handleRequestSort(event: React.MouseEvent<unknown>, property: keyof Row): void {
                            ...
                            {visibleRows.map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align='center'>{row.emailVerified ? <TaskAlt sx={{color: "#308330"}}/> : <></>}</TableCell>
                                        <TableCell>{formatDatetime(row.modifiedOn)}</TableCell>
                                        <TableCell>{formatDatetime(row.deletedOn)}</TableCell>
                                    </TableRow>
                                )
                            })}
                            {emptyRows > 0 && (
